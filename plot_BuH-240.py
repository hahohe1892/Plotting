...
along(mod, mod.results.TransientSolution[-84].Surface, color='blue', linewidth=1)
along(mod, mod.results.TransientSolution[-84].Base, color='blue', linewidth=1)
...
plt.sca(ax2)
along_evol(mod, 'viridis', '','no',-1,'Vel', linewidth=0.8)
...
plt.axes(axins1)
plotcontour(mod, mod.results.TransientSolution[-84].MaskGroundediceLevelset, levels=[0], colors='blue')
plotcontour(mod, mod.geometry.bed, levels=[0], colors='black')
axvspan(begin,end, color='gainsboro', alpha=0.5)
